...
>
> ✅ **`page_code` 확정** (2026-08-03 재확정 · 노션 반영 완료) — **실제 사이드바 기준 카탈로그 6개**,
> 그중 `page_permission` 부여 대상은 `BIDDING`·`FINANCE` **2개**다. 와이어프레임 5개안은 대응 화면이 없어 폐기.
...
> 🚨 **위 8탭 표는 기획 단계 구조다. 실제 사이드바는 아래 7개다** (2026-08-03 화면 확인).
>
