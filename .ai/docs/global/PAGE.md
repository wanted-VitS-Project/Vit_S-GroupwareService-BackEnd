...
**최종 업데이트**: 2026-08-03 (P-62 직급 · P-65 그룹 추가 · `page_code` 재확정 진행) · 이전 2026-08-01
...
>
> 🔴 **`page_code` 재확정 진행 중** (2026-08-03) — 와이어프레임 기준 **5개**로 가기로 결정했으나
> **5개 모두 아래 화면 목록에 대응하는 P-xx 가 없다.** 상세는 [`PERMISSION.md` §3-1](PERMISSION.md).
> 이 문서의 §1 탭 표는 **아직 이전 2개(`BIDDING`·`FINANCE`) 기준**이다. 탭 구조 논의 후 갱신해야 한다.
>
...
| 규칙 | 확정 |
|------|------|
| **`page_code` 목록** | 🔴 **재확정 진행 중** — 와이어프레임 기준 5개로 결정했으나 대응 화면이 없다. [`PERMISSION.md` §3-1](PERMISSION.md) |
