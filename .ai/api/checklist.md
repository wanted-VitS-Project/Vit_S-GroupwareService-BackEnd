...
| 메서드 | 경로 | 무엇 | 상태 | 권한 |
|---|---|---|---|---|
| POST | `/api/v1/blocks/checklists/{chkBlockId}/items` | [체크리스트 항목 생성](#체크리스트-항목-생성-post-apiv1blockschecklistschkblockiditems) | ✅ 확정 | 스텝 편집 권한(`CHK-001`) |
| PATCH | `/api/v1/blocks/checklists/items/{chkId}` | [체크리스트 항목 수정](#체크리스트-항목-수정-patch-apiv1blockschecklistsitemschkid) | ✅ 확정 | 스텝 편집 권한(`CHK-001`) |
| DELETE | `/api/v1/blocks/checklists/items/{chkId}` | [체크리스트 항목 삭제](#체크리스트-항목-삭제-delete-apiv1blockschecklistsitemschkid) | ✅ 확정 | 스텝 편집 권한(`CHK-001`) |
