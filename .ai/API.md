...
**전역 인증 게이트 — 위 6종과 별개로 전 엔드포인트에서 나올 수 있다** (2026-08-16 등재)
...
- [ ] 에러 코드 도메인 접두어 배분
- [x] `2026-08-16` **공통 에러코드 6종(`COMMON_*` 5 + `AUTH_UNAUTHENTICATED`) + 전역 게이트 `AUTH_PASSWORD_RESET_REQUIRED` 를 §3-3 에 등재** — 프론트 폴백 분기 기준 확정
