...
-- 번호: 2026-08-13 재번호 120000 → 160000. develop 최신이 V20260812150000 까지 올라가(SSE 등 67커밋 머지) 120000 이
--       out-of-order 가 됐다(Flyway out-of-order:false 면 부팅 실패). 150000 위인 160000 으로 올린다.
--       ⚠️ develop 이 마이그레이션을 재번호하는 전례(file/add_version_file 주석) — 이 PR 머지 직전 최신 번호 재확인 필수.
