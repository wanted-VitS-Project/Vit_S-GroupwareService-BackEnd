...
-- P8001
(8001, 8001, '공고 검토·신청자격',   1),
(8002, 8001, '훈련과정 설계',        2),
(8003, 8001, '콘텐츠·LMS 준비',      3),
(8004, 8001, '신청서류 작성·제출',   4),
(8005, 8001, '외주 관리',            5),
(8006, 8001, '심사 대응',            6),
(8007, 8001, '선정 후 개설',         7),
-- P8002
(8008, 8002, '과정 개설·모집',       1),
(8009, 8002, '1기 운영',             2),
(8010, 8002, '2기 운영',             3),
(8011, 8002, '훈련비 정산',          4),
(8012, 8002, '성과관리',             5);
...
-- 심사 대응·선정 후 개설 ── 미도래. 블록은 만들되 내용을 비운다 (BLOCK.md §1 규약 5)
