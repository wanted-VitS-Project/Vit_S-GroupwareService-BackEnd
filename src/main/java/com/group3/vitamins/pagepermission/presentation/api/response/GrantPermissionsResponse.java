...
public record GrantPermissionsResponse(
        ...
        @Schema(description = "요청 인원", example = "3") int requestedCount,
        @Schema(description = "신규 부여 인원", example = "1") int grantedCount,
        @Schema(description = "등급 변경 인원", example = "1") int updatedCount,
        @Schema(description = "변화 없음 인원", example = "1") int unchangedCount
) {
