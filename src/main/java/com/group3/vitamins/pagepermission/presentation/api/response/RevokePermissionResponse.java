...
public record RevokePermissionResponse(
        ...
        @Schema(description = "대상 사번", example = "vitas-EMP002") String userId,
        @Schema(description = "회수 후에도 접근 가능한지(MASTER 면 true)", example = "true") boolean stillAccessible,
        @Schema(description = "접근 가능 시 근거 GLOBAL_ROLE, 아니면 null", nullable = true, example = "GLOBAL_ROLE") String accessSource
) {
